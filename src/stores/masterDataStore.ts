...
interface MasterDataState {
  ...
  updateProvider: (
    id: number,
    data: { name: string; rif: string; address: string }
  ) => Promise<Provider>;
...
export const useMasterDataStore = create<MasterDataState>((set, get) => ({
  ...
  fetchProducts: createFetcher(set, get, 'products', getProducts),
  ...
  createUnit: async (data) => {
    ...
    set((state) => ({
      units: [...state.units, newUnit].sort((a, b) =>
  ...
  createPosition: async (data) => {
    ...
    set((state) => ({
      positions: [...state.positions, newPosition].sort((a, b) =>
        a.name.localeCompare(b.name)
      ),
    }));
    return newPosition;
  ...
  createOfficial: async (data) => {
    ...
    set((state) => ({
      officials: [...state.officials, newOfficial].sort((a, b) =>
  ...
  createProvider: async (data) => {
    ...
    set((state) => ({
      providers: [...state.providers, newProvider].sort((a, b) =>
        a.name.localeCompare(b.name)
      ),
    }));
    return newProvider;
  ...
  createAccountPoint: async (data) => {
    ...
    set((state) => ({
      accountPoints: [...state.accountPoints, newAP].sort(
  ...
  updateAccountPoint: async (id, data) => {
    ...
    set((state) => ({
      accountPoints: state.accountPoints.map((ap) =>
        ap.id === id ? updatedAP : ap
      ),
    }));
    return updatedAP;
  },
  deleteAccountPoint: async (id) => {
    ...
    set((state) => ({
      accountPoints: state.accountPoints.filter((ap) => ap.id !== id),
    }));
  },
